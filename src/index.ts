(() => {
    ...
    class Reminder implements Task {
        ...
        render(): string {
            return `
                ...
                date: ${DateUtils.formarDate(this.date)}
    ...
    const todo = new Todo('Todo cirado com a classe');
    ...
    const taskView = {
        ...
        render(tasks: Array<Task>, mode:ViewMode){ //função 
